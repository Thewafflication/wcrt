...
| F-005 | 7.3 | `<complex.h>` types, operators, `complex`, `_Complex_I`, and `I` | required | implemented | Pass | Pass | Pass | REQ-0037 | `include/complex.h`; `src/complex.c` | TC-0037; TC-0042 | Depends on target `_Complex`, imaginary literals, and the selected compiler's matching private operator helpers; TC-0037 and consumer tests gate the contract. |
