...
| C99 interface and isolation | Compile-time, behavioral, C89-isolation, numeric-boundary, and ABI testing | `TC-0019`, `TC-0021`–`TC-0033`, `TC-0035`, `TC-0036`, `TC-0039`, `tests/c99/` |
