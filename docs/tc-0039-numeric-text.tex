...
\def\TCPurpose{Verify hexadecimal floating syntax, documented decimal
accuracy, special values, signed zero, range behavior, and formatted-I/O
integration.}
...
metamorphic hexadecimal and decimal round trips, adjacent-value rounding
partitions, and a retained decimal recommended-practice counterexample.}
...
and verify default-a and 17-digit decimal round trips; compare the shared wide
partitions controlled by REQ-0031.}
