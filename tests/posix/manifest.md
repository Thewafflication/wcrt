...
| REQ-0051 | [TC-0051](../../docs/tc-0051-posix-stat-utime.tex) | `presence/files.c`, `absence/files.c`, `files.c` | Types, path and descriptor declarations, file identity, predicates, strict isolation, time updates, limits, and errors |
| REQ-0052 | [TC-0052](../../docs/tc-0052-posix-dirent.tex) | `presence/dirent.c`, `absence/dirent.c`, `dirent.c` | Declarations, record and name lengths, strict isolation, enumeration, rewind, entry types, end of stream, and errors |
