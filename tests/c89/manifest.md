...
| REQ-0012 | [TC-0012](../../docs/tc-0012-stdio.tex) | `presence/stdio.c`, `stdio.c`, `stdio_stdin.c` | 41 functions; files, temporary streams, redirected and console input, positions, formats, scans |
