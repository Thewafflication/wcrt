...
| REQ-0074 | [TC-0074](../../docs/tc-0074-thread-safe-streams.tex) | `../posix/stdio_threads.c` | Distinct concurrent streams and descriptors, per-stream data, and entry reuse |
