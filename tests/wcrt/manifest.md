...
| REQ-0075 | [TC-0075](../../docs/tc-0075-cpu-information.tex) | `cpu.c`, `cpu_fallback.c`, `cpu_startup.c` | Concurrent discovery, instruction state, affinity updates, old-OS fallback, topology and startup order |
