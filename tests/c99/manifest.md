...
| REQ-0037 | [TC-0037](../../docs/tc-0037-complex.tex) | `presence/complex.c`, `presence/complex-c89.c`, `complex.c`, `data/complex-vectors.json`, `Verify-ComplexVectors.ps1`, `Verify-T5Inventory.ps1` | Complete complex inventory, reproducible 100-digit ordinary vectors, components, operators and private helper ABI, branch cuts, signed zero, exceptional/range values, C89 isolation, and supported TinyCC execution |
